...
#-----------------------------------------------------------------------------------------------------------------------
# Test functions for ggd show-env, ggd list-files, and ggd pkg-info
#-----------------------------------------------------------------------------------------------------------------------
...
def test_list_files():
    ...
    output = temp_stdout.getvalue().strip() 
    assert re.search(file1+"$", output.split("\n")[0])
    assert re.search(file2+"$", output.split("\n")[1])
